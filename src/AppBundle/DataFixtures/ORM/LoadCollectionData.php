...
class LoadCollectionData extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->addCollection('Dicas Fame', 'dicas-fame', 'news');
        $this->addCollection('Famers', 'famers', 'news');
        $this->addCollection('Eventos', 'eventos', 'news');
    }

    public function addCollection($name, $slug, $context, $description = '', $enabled = true)
    {
